...
Katalog 256 tarif içerir. Türk, İtalyan, Asya, Meksika, Akdeniz ve diğer desteklenen mutfaklar; kahvaltı, çorba, ana yemek, salata/meze, hamur işi ve tatlı kategorileri bulunur. Diyet etiketleri, süreler, kişi sayıları ve ingredient miktarları seed verisinde tutulur.
...
Bu dosya, Akşam Ne Yesem? uygulamasının güncel SQLite + Drizzle tabanlı yerel recommendation mimarisini ve 256 tariflik kataloğunu yansıtır.
